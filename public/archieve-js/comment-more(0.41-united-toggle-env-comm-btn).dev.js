		...
		"<div id='cm-app-head' style='text-align:right;' >",
			"<div style='float:left;' >", //left side
				...
				"<button id='cm-toggle-env-comm-button' class='cm-buttons cm-font cm-black ' >",
					"<span id='cm-toggle-env-comm-ico' class='cm-font cm-black ' ></span>",
					" ",
			...
			"<span id='cm-app-status' class='cm-font cm-black ' > </span> ",
			"<span class='cm-font cm-grey ' ><a href='",hostDomain,"' title='Project site' target=blank class='cm-link cm-font cm-grey ' ><b>CommentMore</a></b><sup id='cm-version' class='cm-grey ' >",
			CMVersion,
			" </sup></span>",
     ...
     success: function(res) {
	     echo("Success get"/*,res.answer*/);//dm
			 ...
			 for (key in res.answer) { //res.answer?
					...
					tab.innerHTML= str("<b>",current.author,"</b> (",dateTimeStr,"): <br>",current.userComment," ");
