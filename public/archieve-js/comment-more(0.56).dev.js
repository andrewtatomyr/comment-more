...
function applyStyle() {
	...
	$("#cm-user-comment").css({ //style='width:100%; margin-bottom:0px; '
		"width": "100%",
		//"max-width": str(parseInt($("#cm-app-panel").css("width")),"px"), //-parseInt($("#cm-app-panel").css("padding-left"))-parseInt($("#cm-app-panel").css("padding-right")), //?
		//"min-width": str(parseInt($("#cm-app-panel").css("width")),"px"),
		//"max-width": $("#cm-user-comment").css("width")),
		//"min-width": $("#cm-user-comment").css("width")),
		"margin-bottom": "0px"
	});
...
function setAppPanel() {
	...
	appPanel.innerHTML= str(
		...
		"<div id='cm-enhanced-area' style='display:none; ' >",
			...
			"<textarea id='cm-user-comment' placeholder='Your comment' class='cm-font cm-black ' ></textarea>",
